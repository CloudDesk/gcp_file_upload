...
const config = {
    ...
    REVO_BLOGS_IMAGES_API: process.env.REVO_BLOGS_IMAGES_API,
    ...
    REVO_PRODUCT_INVOICE_BUCKET: process.env.REVO_PRODUCT_INVOICE_BUCKET,
    REVO_SERVICE_INVOICE_BUCKET: process.env.REVO_SERVICE_INVOICE_BUCKET,
    REVO_PRODUCT_IMAGES_BUCKET: process.env.REVO_PRODUCT_IMAGES_BUCKET,
    REVO_RATINGS_IMAGES_BUCKET: process.env.REVO_RATINGS_IMAGES_BUCKET,
...
export const { REVO_BLOGS_IMAGES_API } = config;
export const { REVO_PO_BUCKET } = config;
export const { REVO_PR_BUCKET } = config;
export const { REVO_COST_ESTIMATION_BUCKET } = config;
export const { REVO_PRODUCT_INVOICE_BUCKET } = config;
export const { REVO_SERVICE_INVOICE_BUCKET } = config;
export const { REVO_PRODUCT_IMAGES_BUCKET } = config;
export const { REVO_RATINGS_IMAGES_BUCKET } = config;
