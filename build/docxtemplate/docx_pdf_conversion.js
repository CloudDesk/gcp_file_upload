...
const convertToPdf = async (docxBuffer, pdfFilename, id) => {
    try {
        ...
        console.log(`PDF ${pdfFilename} uploaded successfully to Google Cloud Storage`);
        return { fileUrl, id };
    }
    catch (error) {
...
//# sourceMappingURL=docx_pdf_conversion.js.map